...
describe MyHashSet do
  ...
  describe "set interaction methods" do
    before(:each) do
      ...
      set4.insert("Ewan McGregor")
      set4.insert("Natalie Portman")
      set4.insert("Anthony Daniels")
    ...
    describe "#symmetric_difference" do
      ...
      it "returns a set containing elements ONLY in the either set" do
    ...
    describe "#==" do
      ...
      it "returns false for different elements" do
        expect(set1==set2).to be_falsey
      end

      it "returns true for equal objects" do
        expect(set2==set4).to be_truthy
      end
